...
src_prepare() {
	...
	if use test; then
		mv "${WORKDIR}/AnyEvent-I3-${AEVER}" "${S}/AnyEvent-I3" ||\
			die "Can't relocate AnyEvent-I3-${AEVER} directory"

		sed -i -e 's/use inc::Module::Install;/use lib q[.];\nuse inc::Module::Install;/' "${S}/AnyEvent-I3/Makefile.PL" ||\
